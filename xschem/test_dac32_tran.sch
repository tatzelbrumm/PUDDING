...
N 920 -560 920 -540 {lab=Vpbias[1:0]}
N 920 -640 920 -620 {lab=#net2}
N 880 -540 880 -520 {lab=Vpcbias[1:0]}
N 880 -620 880 -600 {lab=iin}
N 1320 -100 1420 -100 {lab=GND}
N 1180 -420 1260 -420 {lab=onb[31:0]}
N 1180 -420 1180 -360 {lab=onb[31:0]}
N 1120 -360 1180 -360 {lab=onb[31:0]}
N 1160 -440 1260 -440 {lab=on[31:0]}
N 1160 -440 1160 -380 {lab=on[31:0]}
N 1120 -380 1160 -380 {lab=on[31:0]}
...
N 1120 -540 1260 -540 {lab=Vpbias[1:0]}
N 1220 -520 1260 -520 {lab=Vpcbias[1:0]}
N 620 -620 880 -620 {lab=iin}
N 1220 -700 1220 -660 {lab=VDD}
N 1180 -700 1220 -700 {lab=VDD}
N 1250 -660 1260 -660 {lab=VDD}
N 1260 -700 1260 -660 {lab=VDD}
N 1220 -700 1260 -700 {lab=VDD}
N 1180 -660 1190 -660 {lab=VDD}
N 1180 -700 1180 -660 {lab=VDD}
N 1160 -700 1180 -700 {lab=VDD}
N 1120 -700 1120 -660 {lab=VDD}
N 1080 -700 1120 -700 {lab=VDD}
N 1150 -660 1160 -660 {lab=VDD}
N 1160 -700 1160 -660 {lab=VDD}
N 1120 -700 1160 -700 {lab=VDD}
N 1080 -660 1090 -660 {lab=VDD}
N 1080 -700 1080 -660 {lab=VDD}
N 1060 -700 1080 -700 {lab=VDD}
N 1120 -620 1120 -540 {lab=Vpbias[1:0]}
N 920 -540 1120 -540 {lab=Vpbias[1:0]}
N 1220 -620 1220 -520 {lab=Vpcbias[1:0]}
N 880 -520 1220 -520 {lab=Vpcbias[1:0]}
N 600 -700 600 -620 {lab=VDD}
N 540 -700 600 -700 {lab=VDD}
...
*plot 0.5*(vidacp#branch+vidacn#branch) vidacp#branch-vidacn#branch
.endc
"}
...
C {lab_wire.sym} 920 -540 0 0 {name=p2 lab=Vpbias[1:0]}
C {lab_wire.sym} 880 -520 0 0 {name=p3 lab=Vpcbias[1:0]}
C {lab_wire.sym} 680 -700 0 0 {name=p1 lab=VDD}
C {lab_wire.sym} 1420 -370 3 0 {name=p4 lab=Vout}
C {lab_wire.sym} 1240 -420 0 0 {name=p7 sig_type=std_logic lab=onb[31:0]}
C {lab_wire.sym} 1240 -440 0 0 {name=p8 sig_type=std_logic lab=on[31:0]}
...
C {vsource.sym} 920 -590 0 0 {name=Vpleak[1:0] value=0 savecurrent=true}
C {dac32module.sym} 1320 -480 0 0 {name=xdac}
C {analog_wires.sym} 540 -640 0 0 {name=xbypass}
C {vsource.sym} 880 -570 0 1 {name=Vpcleak1[1:0] value=0 savecurrent=true}
C {lab_wire.sym} 680 -620 2 1 {name=p5 lab=iin}
C {inverterpair.sym} 840 -480 0 0 {name=xen[3:0]}
C {inverterpair.sym} 1060 -380 0 0 {name=xdrv[31:0]}
...
C {sg13g2_pr/sg13_hv_pmos.sym} 1220 -640 1 1 {name=Mcbuffer[1:0]
l=4.46u
w=8u
ng=1
m=2
...
C {sg13g2_pr/sg13_hv_pmos.sym} 1120 -640 1 1 {name=Mbbuffer[1:0]
l=4.46u
w=16u
ng=1
m=2

...
set appendwrite
dc Vout 0 1.6 10m VlogI -7 -5 0.5
*tran 10n 500u
write test_dac128_dc.raw
plot 2*(vout#branch-8*vprobe#branch)/(8*vprobe#branch+vout#branch)
...
C {vsource.sym} 1180 -570 0 1 {name=Vpcleak[1:0] value=0 savecurrent=true}

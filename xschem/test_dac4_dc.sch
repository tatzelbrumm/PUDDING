...
N 1180 -420 1260 -420 {lab=onb[3:0]}
N 1180 -420 1180 -360 {lab=onb[3:0]}
N 1120 -360 1180 -360 {lab=onb[3:0]}
N 1160 -440 1260 -440 {lab=on[3:0]}
N 1160 -440 1160 -380 {lab=on[3:0]}
N 1120 -380 1160 -380 {lab=on[3:0]}
...
save all 
op
write test_dac4_dc.raw
set appendwrite
dc Vout 0 1.6 10m VlogI -8 -6 0.5
*tran 10n 500u
write test_dac4_dc.raw
plot title \\"output/reference current asymmetry\\" 2*(vout#branch-vprobe#branch)/(vprobe#branch+vout#branch)
plot ylimit -6m 2m title \\"output/reference current asymmetry\\" 2*(vout#branch-vprobe#branch)/(vprobe#branch+vout#branch)
...
C {lab_wire.sym} 1240 -420 0 0 {name=p7 sig_type=std_logic lab=onb[3:0]}
C {lab_wire.sym} 1240 -440 0 0 {name=p8 sig_type=std_logic lab=on[3:0]}
...
C {dac4module.sym} 1320 -480 0 0 {name=xdac}
...
C {inverterpair.sym} 1060 -380 0 0 {name=xdrv[3:0]}

...
N 1000 -620 1040 -620 {lab=ONB[19:0]}
...
N 1360 -640 1420 -640 {lab=ON[39:20]}
N 1360 -620 1400 -620 {lab=ONB[39:20]}
...
N 420 -100 1400 -100 {lab=ONB[39:0]}
N 980 -640 1040 -640 {lab=ON[19:0]}
N 420 -140 1420 -140 {lab=ON[39:0]}
N 420 -220 1660 -220 {lab=ENB[3:0]}
N 420 -260 1640 -260 {lab=EN[3:0]}
N 1660 -620 1660 -230 {lab=ENB[3:2]}
N 1640 -640 1640 -270 {lab=EN[3:2]}
N 1400 -620 1400 -110 {lab=ONB[39:20]}
N 1420 -640 1420 -150 {lab=ON[39:20]}
N 1000 -620 1000 -110 {lab=ONB[19:0]}
N 980 -640 980 -150 {lab=ON[19:0]}
...
C {unitsource2u.sym} 1100 -660 0 0 {name=xsrc[19:0]}
C {ipin.sym} 420 -140 0 0 {name=p7 sig_type=std_logic lab=ON[39:0]}
C {ipin.sym} 420 -100 0 0 {name=p8 sig_type=std_logic lab=ONB[39:0]}
...
C {unitsource2u.sym} 1300 -660 0 1 {name=xsrc1[39:20]}
...
C {lab_wire.sym} 440 -140 0 1 {name=p28 lab=ON[39:0]}
C {lab_wire.sym} 440 -100 0 1 {name=p29 lab=ONB[39:0]}
...
C {bus_tap.sym} 970 -140 0 0 {name=l6 lab=[19:0]}
C {bus_tap.sym} 990 -100 0 0 {name=l7 lab=[19:0]}
C {bus_tap.sym} 1410 -140 0 0 {name=l8 lab=[39:20]}
C {bus_tap.sym} 1390 -100 0 0 {name=l9 lab=[39:20]}

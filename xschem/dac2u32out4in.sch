...
N 1000 -440 1040 -440 {lab=ON[15:0]}
N 1000 -420 1040 -420 {lab=ONB[15:0]}
...
N 1360 -420 1400 -420 {lab=ONB[31:16]}
...
C {unitsource2u.sym} 1100 -460 0 0 {name=xsrc[15:0]}
C {ipin.sym} 1000 -440 0 0 {name=p7 sig_type=std_logic lab=ON[15:0]}
C {ipin.sym} 1000 -420 0 0 {name=p8 sig_type=std_logic lab=ONB[15:0]}
...
C {unitsource2u.sym} 1780 -460 0 0 {name=xref[3:2]}
C {unitsource2u.sym} 1300 -460 0 1 {name=xsrc[31:16]}
C {ipin.sym} 1400 -440 0 1 {name=p12 sig_type=std_logic lab=ON[31:16]}
C {ipin.sym} 1400 -420 0 1 {name=p13 sig_type=std_logic lab=ONB[31:16]}

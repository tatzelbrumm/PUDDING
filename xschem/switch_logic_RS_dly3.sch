...
N -330 -190 -220 -190 {lab=EN}
N -330 -190 -330 -50 {lab=EN}
N -410 -190 -330 -190 {lab=EN}
N -330 180 -220 180 {lab=EN_N}
N -330 30 -330 180 {lab=EN_N}
...
N 200 -170 260 -170 {lab=OFF_N}
N 200 160 260 160 {lab=OFF_N}
...
C {ipin.sym} -410 -190 0 0 {name=p3 lab=EN}
C {opin.sym} 260 160 0 0 {name=p4 lab=ON_N}
C {opin.sym} 260 -170 0 0 {name=p5 lab=OFF_N}
...
"}
C {lab_wire.sym} -260 180 0 0 {name=p6 sig_type=std_logic lab=EN_N}
